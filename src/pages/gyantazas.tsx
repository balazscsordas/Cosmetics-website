...
export const GyantazasPage = () => {
  return (
    <>
      <Head>
        <title>Gyantázás | Dorin Kozmetika - Győr</title>
      ...
      <main>
        <Layout>
          <Banner text="Gyantázás" bg="gyantazas-bg" />
          {services[4].treatments.map((treatment, index) => (
