...
export const RelaxaloKezelesekPage = () => {
  return (
    <>
      <Head>
      ...
      <main>
        <Layout>
          <Banner text="Relaxáló kezelések" bg="relaxalo-kezelesek-bg" />
          {services[3].treatments.map((treatment, index) => (
...
export default RelaxaloKezelesekPage
